      ...
      <main id="main" className="relative px-5 pb-24 pt-32 sm:px-8 sm:pt-40">
        <div className="relative mx-auto max-w-6xl">
          ...
          <section className="mt-10 grid gap-10 lg:grid-cols-[1fr_0.72fr] lg:items-end">
            <Reveal>
              <div>
                ...
                <h1 className="mt-4 max-w-3xl text-4xl font-extrabold tracking-[-0.03em] text-ink sm:text-5xl md:text-6xl md:leading-[1.03]">
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  <Link
                    href="/signup"
                    className="inline-flex items-center justify-center gap-2 border border-ink bg-stamp px-6 py-3 text-sm font-semibold text-paper-raised shadow-stamp transition-colors hover:bg-stamp-deep"
                  >
                  ...
                  <Link
                    href="/#cloud-platform"
                    className="inline-flex items-center justify-center border border-ink bg-paper-raised px-6 py-3 text-sm font-semibold text-ink transition-colors hover:border-stamp hover:text-stamp"
                  >
            ...
            <Reveal delay={0.08}>
              <div className="notch-corner border border-ink bg-paper-raised p-8 shadow-raised">
                <div className="flex size-12 items-center justify-center border border-ink bg-paper text-stamp">
                  <CalendarDays className="size-5" strokeWidth={1.75} aria-hidden="true" />
                </div>
                <h2 className="mt-5 text-2xl font-bold tracking-[-0.02em] text-ink">
          ...
          <section className="mt-16 sm:mt-20">
            <Reveal>
              ...
              <p className="mt-2 max-w-2xl text-sm text-ink-2">
                ...
                <Link href="/#cloud-platform" className="font-semibold text-stamp hover:text-stamp-deep">
                  Cloud Platform
                </Link>{" "}
          ...
          <section className="mt-16 sm:mt-20">
            <Reveal>
              <div className="flex items-center gap-3">
                <h2 className="text-3xl font-bold tracking-[-0.02em] text-ink">Convoy Cloud FAQ</h2>
