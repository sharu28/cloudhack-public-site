...
/**
 * Schedule - a three-stage ledger for the remote build and in-person final.
 *
...
export function Schedule() {
  ...
  return (
    <Section id="schedule" eyebrow="Three-day format" title={schedule.heading} intro={schedule.intro}>
      <ManifestList>
